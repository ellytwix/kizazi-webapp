...
echo "=== COMPREHENSIVE FIX: Translations + Backend + Design ==="

# 1. Fix LanguageContext to support nested translations
echo "--- 1. Fixing translation system ---"
cat > src/contexts/LanguageContext.jsx <<'LANG_FIX'
...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      regionSelection: {
        title: 'Welcome to KizaziSocial',
        subtitle: 'Choose your region to get started'
      },
      sidebar: {
        dashboard: 'Dashboard',
    ...
    sw: {
      ...
      regionSelection: {
        title: 'Karibu KizaziSocial',
        subtitle: 'Chagua mkoa wako ili uanze'
      },
      sidebar: {
        dashboard: 'Dashibodi',
...
# 2. Fix backend /ping endpoint
echo "--- 2. Ensuring backend /ping endpoint works ---"
cat > server/routes/ping.js <<'PING_FIX'
...
# 3. Update App.jsx with preferred design + fixed translations
echo "--- 3. Updating App.jsx with preferred purple design ---"
cat > src/App.jsx <<'APP_DESIGN_FIX'
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <img src="/logo.jpg" alt="KizaziSocial" className="w-10 h-10 rounded-lg" />
            <h1 className="text-xl font-bold text-gray-800">KizaziSocial</h1>
          </div>
        </div>
...
// Sidebar Component (Purple Design like in Screenshot)
      ...
      `}>
        <div className="p-6">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-2">
              <img src="/logo.jpg" alt="KIZAZI" className="w-8 h-8 rounded-lg" />
            ...
            <button
              ...
              className={`
                ...
                ${activeSection === item.id 
                  ? 'bg-purple-600/30 text-white shadow-lg border border-purple-400/30' 
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <div className="bg-white/10 rounded-lg p-3 text-center">
            ...
            <div className="text-white text-sm">Partly Cloudy</div>
          </div>
        </div>
      </aside>
    </>
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">{t('sidebar.dashboard')}</h1>
          <p className="text-gray-600 mt-1">{t('dashboardContent.welcome')}</p>
        </div>
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Create engaging social media content with AI</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-purple-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-purple-700 disabled:opacity-50 transition-all"
            >
          ...
          {generatedContent && (
            <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <button
                ...
                className="mt-3 text-sm bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition"
              >
                Copy to Clipboard
              </button>
            </div>
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="px-4 py-2 bg-purple-600 text-white rounded-lg shadow hover:bg-purple-700 transition">New Post</button>
        </div>
            ...
            {posts.map(p => (
              <div key={p.id} className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div className="flex items-start justify-between mb-2">
                  <p className="font-bold text-gray-900">{p.platform}</p>
                  <span className={`px-2 py-1 rounded text-xs font-medium ${
                    p.status === 'scheduled' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                  }`}>
                    {p.status}
                  </span>
                </div>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="text-right">
          <a href="/api/analytics/export/csv" download="analytics.csv" className="inline-block px-5 py-3 bg-purple-600 text-white font-semibold rounded-lg shadow-lg hover:bg-purple-700 transition-transform transform hover:scale-105">
            Download Report (CSV)
          </a>
        </div>
      </div>
  ...
  <div className="p-6 bg-gray-50 min-h-screen">
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Flexible plans for every team</p>
      </div>
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <p className="text-gray-600 text-lg">Choose the perfect plan for your social media needs.</p>
      </div>
    </div>
  </div>
);
...
# 4. Restart backend to ensure /ping endpoint works
echo "--- 4. Restarting backend ---"
pm2 restart kizazi-backend || echo "Backend restart failed, continuing..."
...
echo "✅ Fixed sidebar translations (no more 'sidebar.' prefixes)"
echo "✅ Enhanced backend ping endpoint"  
echo "✅ Restored purple gradient design like in your screenshot"
echo "✅ Kept all new functionality (AI, analytics, etc.)"
echo ""
echo "Hard-refresh your browser (Ctrl+Shift+R) to see the fixed design!"
echo ""
